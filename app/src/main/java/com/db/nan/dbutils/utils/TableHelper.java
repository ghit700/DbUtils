package com.db.nan.dbutils.utils;
...
import com.db.nan.dbutils.utils.annotation.Column;
import com.db.nan.dbutils.utils.annotation.Table;
...
public class TableHelper extends SQLiteOpenHelper {
     ...
     * @return
     */
    public boolean isExistsTable(String tableName, SQLiteDatabase db) {
     ...
     * @throws Exception
     */
    public void buildTable(Class clz, SQLiteDatabase db) throws Exception {
     ...
     * @return
     */
    public String buildColumn(Field f) {
        StringBuilder sql = new StringBuilder();
     ...
     * @return
     */
    public String getColumnType(Class clz) {
        String type;
        if (int.class == clz || java.lang.Integer.class.equals(clz)
                ...
                boolean.class == clz || java.lang.Boolean.class == clz ||
                Date.class == clz) {
            type = "INTEGER";
     ...
     * @throws Exception
     */
    public void alterTable(Class clz, SQLiteDatabase db, boolean isAlterTable) throws Exception {
        if (clz.isAnnotationPresent(Table.class)) {
...
//                    4.删除旧表
     ...
     * @param tableName
     */
    public void alterTableToTemp(String tableName, SQLiteDatabase db) {
     ...
     * 添加字段
     */
    public void addColumn(String tableName, Class clz, SQLiteDatabase db) {
